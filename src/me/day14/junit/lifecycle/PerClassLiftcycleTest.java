package me.day14.junit.lifecycle;

import org.junit.jupiter.api.*;

@TestInstance(TestInstance.Lifecycle.PER_METHOD) // 클래스 안에 객체 1개 (싱글톤)
class PerClassLiftcycleTest {
    ...
    @BeforeAll
    static void beforeTheEntireTestFixture() { // 공유 인스턴스로 인해 static일 필요 없음
        System.out.println("Before the entire test fixture");
    }

    @AfterAll
    static void afterTheEntireTestFixture() { // 공유 인스턴스로 인해 static일 필요 없음
